...
define(function(require, exports, module) {
    ...
    module.exports = PopupLayer = new Class({
            ...
            popup : function (e){   //给触发元素的触发弹出事件
                ...
                $(this).trigger("onBeforeStart", e); //执行自定义事件。
                this._construct();
                var left = null;
                var top = null;
                // mouseenter定位
            ...
            _loadOverlay: function() { //加载遮罩
                ...
                var pageWidth = isIe6 ? $(document).width() - 17 : $(document).width();
                ...
                isIe6 ? this.overlay.append("<div style='position:absolute;z-index:1000;width:100%;height:100%;left:0;top:0;opacity:0.3;filter:Alpha(opacity=30);background:#000'></div><iframe frameborder='0' border='0' style='width:100%;height:100%;position:absolute;z-index:999;left:0;top:0;filter:Alpha(opacity=0);'></iframe>"): null;
            },
            doresize: function() {
                var isIe6 = !-[1,] && !window.XMLHttpRequest;   // 前者为判断IE浏览器，后为判断版本
